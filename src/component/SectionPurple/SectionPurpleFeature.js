                ...
                <div className="w-layout-blockcontainer heygen_container w-container">
                    <div className="feature_gaps">
                        <div className="features_wrapper">
                            <div id="w-node-_31c742be-50fd-7404-1cbe-c4610e7b35b4-8c4e74c2"
                            ...
                            <div id="w-node-_253ab555-c697-be58-2042-b6da174b5dbe-8c4e74c2" className="feature_card_2">
                                ...
                                <div className="feature_content_wrap">
                                    ...
                                    <p className="feature_card_para font-white">Effortlessly translate your videos using our
                                        one-click solution that clones your natural speaking voice and style for
                                        seamless delivery in other languages.</p><a href="/"
                                ...
                                <div className="translater_video_wrap w-embed">
                                    ...
                                    <video className="translator_video"
                                        src="https://resource.heygencdn.com/homepage/vt5s2.mp4" type="video/mp4" muted
                                        autoplay loop>
                                    </video>
                                </div><img
                                    ...
                                    alt="" className="video-preview feature-1" />
                            </div>
                            <div id="w-node-_8535cf39-702b-1a8b-780a-ca82bd13d3c2-8c4e74c2" className="feature_card_1">
                                <div className="feature_content_wrap">
                                    <h3 className="feature_card_head">API</h3>
                                    <p className="feature_card_para">Integrate HeyGen’s powerful AI capabilities into your
                                        product and create amazing avatar videos programmatically with HeyGen&#x27;s
                                        API.</p>
                                </div>
                                <div className="div-block-302"><img
                                        ...
                                        alt="" className="full-width-img" /></div>
                            </div>
                        </div>
                        <div className="feature_row_grid_2">
                            <div className="feature_card_3">
                                <div>
                                    ...
                                    <p className="feature_card_para">Accelerate your video creation with our AI writing
                                        assistant.</p>
                                </div>
                                <div data-w-id="ef041e90-3d1c-955c-2c47-18b6268bc50f" className="gpt_video_wrap"><img
                                        src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/6564332ddcbd1d3b7f4c98bd_feature_script_img.svg"
                                        loading="lazy" alt="" className="full-width-img" />
                                    <div className="gpt_video w-embed"><video className="muted-video"
                            ...
                            <div className="feature_card_4">
                                <div className="feature_content_wrap">
                                    ...
                                    <p className="feature_card_para is-white">Elevate your avatar for any occasion with a
                                        wide range of customizable clothing options.</p>
                                </div><img
                        ...
                        <div className="feature_row_grid_4">
                            <div className="feature_card_5">
                                <div className="feature_content_wrap">
                                    ...
                                    <p className="feature_card_para is-white">Using HeyGen couldn’t be easier, streamline
                                        your video creation process from your favorite platform.</p>
                                </div>
                                <div className="feature_integration_logos_wrap">
                                    <div className="feature_integration_logos">
                                        <div className="integration_logos_row"><img
                                                src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/656437be31f6f4a6fe2e16a6_zapier.webp"
                                                loading="lazy" alt="" className="feature_integration_logo" /><img
                                                ...
                                                loading="lazy" alt="" className="feature_integration_logo" /></div>
                                        <div className="integration_logos_row"><img
                                                src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/656437be31f6f4a6fe2e16a6_zapier.webp"
                                                loading="lazy" alt="" className="feature_integration_logo" /><img
                                                src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/656437c09837db5b566a7bae_canva.webp"
                            ...
                            <div className="feature_card_6">
                                ...
                                <div className="feature_6_controls">
                                    ...
                                    <div className="slider_control_wrap_feature">
                                        <div id="popular_prev_btn" className="btn_slide_left_icon is-active w-embed"><svg
                                        ...
                                        <div id="popular_next_btn" className="btn_slide_right_icon is-active w-embed"><svg
                                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fillRule="evenodd" clip-rule="evenodd"
                                    ...
                                    <div className="slider_control_wrap_feature is-hidden">
                                        <div id="advertising_prev_btn" className="btn_slide_left_icon is-active w-embed">
                                        ...
                                        <div id="advertising_next_btn" className="btn_slide_right_icon is-active w-embed">
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fillRule="evenodd" clip-rule="evenodd"
                                                    d="M16.5833 10C16.5833 10.4142 16.2475 10.75 15.8333 10.75L4.16658 10.75C3.75237 10.75 3.41658 10.4142 3.41658 10C3.41658 9.58579 3.75237 9.25 4.16658 9.25L15.8333 9.25C16.2475 9.25 16.5833 9.58579 16.5833 10Z"
                                    ...
                                    <div className="slider_control_wrap_feature is-hidden">
                                        <div id="ecommerce_prev_btn" className="btn_slide_left_icon is-active w-embed"><svg
                                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fillRule="evenodd" clip-rule="evenodd"
                                                    d="M3.41681 10C3.41681 9.58579 3.7526 9.25 4.16681 9.25L15.8335 9.25C16.2477 9.25 16.5835 9.58579 16.5835 10C16.5835 10.4142 16.2477 10.75 15.8335 10.75L4.16681 10.75C3.7526 10.75 3.41681 10.4142 3.41681 10Z"
                                        ...
                                        <div id="ecommerce_next_btn" className="btn_slide_right_icon is-active w-embed"><svg
                                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fillRule="evenodd" clip-rule="evenodd"
                                                    d="M16.5833 10C16.5833 10.4142 16.2475 10.75 15.8333 10.75L4.16658 10.75C3.75237 10.75 3.41658 10.4142 3.41658 10C3.41658 9.58579 3.75237 9.25 4.16658 9.25L15.8333 9.25C16.2475 9.25 16.5833 9.58579 16.5833 10Z"
                                ...
                                <div id="popular-slider" className="splide">
                                    <div className="splide__track">
                                        <div className="splide__list feature_template_card_wrap"><a
                                                href="/" target="_blank"
                                                className="splide__slide feature_template_card w-inline-block"><img
                                                    ...
                                                    loading="lazy" sizes="(max-width: 479px) 76vw, 313px"
                                                    ...
                                                    alt="" className="full-width-img _100-height" /></a><a
                                                href="/" target="_blank"
                                                className="splide__slide feature_template_card w-inline-block"><img
                                                    ...
                                                    alt="" className="full-width-img _100-height" /></a></div>
                                    </div>
                                </div>
                                <div id="advertising-slider" className="splide">
                                    <div className="splide__track">
                                        <div className="splide__list feature_template_card_wrap is-hidden"><a
                                                href="/" target="_blank"
                                                className="splide__slide feature_template_card w-inline-block"><img
...
export default SectionPurpleFeature