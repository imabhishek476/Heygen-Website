            ...
            <div className="gobal_padding">
                <div className="w-layout-blockcontainer heygen_container w-container">
                    <div className="create_heading_wrap">
                        <h2 className="heygen_section_heading">Create videos for every team</h2>
                        <p className="create_para">Engage, explain, entertain - AI-Powered video creation for any need.</p>
                    </div>
                    <div className="create_crads_grid">
                        <div id="w-node-_9e87974b-df6e-013a-efff-d6e90fb9dbbd-8c4e74c2" className="create_crads_col">
                            <div className="create_video_card">
                                <div className="relative create_video_wrap"><img
                                        src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/656d2de9b149e5acd83d8c71_Video%20Frame.webp"
                                        loading="lazy" sizes="(max-width: 479px) 44vw, 100vw"
                                    ...
                                    <div className="create_video_wrap w-embed"><video className="muted-video"
                                    ...
                                    <div className="button_play is-create-mobile">
                                        <div className="btn_play_video_icon w-embed"><svg width="16" height="16"
                                ...
                                <div className="create_card_content is-relative">
                                    <div className="create_card_details">
                                        <div>
                                            <h3 className="create_cred_head">Sales outreach<br /><span
                                                    className="light-purple_span">that converts</span></h3>
                                            <div className="create_cred_info">Create personalized outreach videos at scale
                                            </div>
                                        </div>
                                        <div className="create_card_btns"><a href="/"
                                                target="_blank" className="button_primary is-create w-inline-block">
                                                <div>Get started</div>
                                                <div className="btn_right_arrow_icon w-embed"><svg viewBox="0 0 16 16"
                            ...
                            <div className="create_video_card">
                                ...
                                <div className="create_card_content is-relative">
                                    <div className="create_card_details">
                                        <div>
                                            <h3 className="create_cred_head">Content marketing<br />‍<span
                                                    className="light-purple_span">that engage</span></h3>
                                            <div className="create_cred_info">Supercharge your content calendar with videos
                                            </div>
                                        </div>
                                        <div className="create_card_btns"><a href="/"
                                                target="_blank" className="button_primary is-create w-inline-block">
                        ...
                        <div id="w-node-a4e5afa5-c9c5-7cb7-c74a-6442a809679c-8c4e74c2" className="create_col-2">
                            <p className="create_para-_pc">Engage, explain, entertain. AI-powered video creation for any
                                need.</p>
                            <div id="w-node-f981df19-6f0d-952b-c930-593ac824a8f2-8c4e74c2" className="create_crads_col">
                                <div className="create_video_card">
                                    <div className="relative create_video_wrap"><img
                                            ...
                                            alt="" className="video-preview" />
                                        <div className="create_video_wrap w-embed"><video className="muted-video" src="https://resource.heygencdn.com/homepage/usecase_productmarketing2.mp4
    " type="video/mp4" muted autoplay loop>
                                            </video></div>
                                        <div className="button_play is-create-mobile">
                                            <div className="btn_play_video_icon w-embed"><svg width="16" height="16"
                                    ...
                                    <div className="create_card_content is-relative">
                                        <div className="create_card_details">
                                            <div>
                                                <h3 className="create_cred_head">Product marketing<br />‍<span
                                                        className="light-purple_span">that resonates</span></h3>
                                                <div className="create_cred_info">Produce engaging &amp; concise product
                                                    videos</div>
                                            </div>
                                            <div className="create_card_btns"><a href="/"
                                                    target="_blank" className="button_primary is-create w-inline-block">
                                ...
                                <div className="create_video_card">
                                    <div className="relative create_video_wrap"><img
                                            ...
                                            loading="lazy" sizes="(max-width: 479px) 44vw, 100vw"
                                            srcset="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65b35cde0880db9a6908a3c9_Frame%20Extractor-p-500.png 500w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65b35cde0880db9a6908a3c9_Frame%20Extractor-p-800.png 800w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65b35cde0880db9a6908a3c9_Frame%20Extractor-p-1080.png 1080w, https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/65b35cde0880db9a6908a3c9_Frame%20Extractor.png 1440w"
                                            alt="" className="video-preview" />
                                        <div className="create_video_wrap w-embed"><video className="muted-video"
                                    ...
                                    <div className="create_card_content is-relative">
                                        <div className="create_card_details">
                                            <div>
                                                <h3 className="create_cred_head">Learning &amp; development<br /><span
                                                        className="light-purple_span">that teaches</span></h3>
                                                <div className="create_cred_info">Create training videos your team will
                                                    actually watch</div>
                                            </div>
                                            <div className="create_card_btns"><a href="/"
                                                    target="_blank" className="button_primary is-create w-inline-block">
