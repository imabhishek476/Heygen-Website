            ...
            <div className="voices_padding">
                <div className="w-layout-blockcontainer heygen_container w-container">
                    <div className="voices_wrap">
                        <div className="voices_content">
                            <div className="section_head_padding_2">
                                <div className="section_head_padding voice">
                                    ...
                                    <p className="heygen_para">Select a premium voice across any style or language. Benefit
                                        from our AI-Driven text reader, infusing human-like intonation and inflections
                                        with exceptional accuracy.</p>
                                </div>
                                <div className="_2_btns_or_wrap voices"><a href="/"
                                        target="_blank" className="button_primary w-inline-block"><img
                                            src="https://assets-global.website-files.com/63fdcbe48aa020c0a5493507/6560d706514c51af627b9c97_how-btn-img.webp"
                                            loading="lazy" alt="" className="image-82" />
                        ...
                        <div id="w-node-_308966cd-076e-95bb-ba41-8ea73468f53e-8c4e74c2"
                            ...
                            <div className="voices_slider shadows_2 voice-fixed1">
                                <div className="voice_slider_heading_div">
                                    <h3 className="voices_slider_heading"><span className="purple-span">300+</span> voices</h3>
                                    <div className="slider_control_wrap">
                                        <div id="voices_prev_btn" className="btn_slide_left_icon is-active w-embed"><svg
                                        ...
                                        <div id="voices_next_btn" className="btn_slide_right_icon is-active w-embed"><svg
                                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fillRule="evenodd" clip-rule="evenodd"
                                    ...
                                    <div className="splide__track">
                                        <div className="splide__list voices_slider_content">
                                            <div className="splide__slide button_ai_voice">
                                                <div className="audio_voice w-embed"><audio preload="none"
                                                        src="https://resource.heygencdn.com/homepage/LeviFriendly_out.mp3"></audio>
                                                </div>
                                                <div className="btn_play_voice_icon w-embed"><svg width="16" height="16"
                                                ...
                                                <div className="btn_playing_voice_icon is-hidden w-embed"><svg width="16"
                                            ...
                                            <div className="splide__slide button_ai_voice">
                                                <div className="audio_voice w-embed"><audio preload="none"
                                                        src="https://resource.heygencdn.com/homepage/CharlesNatural_out.mp3"></audio>
                                                </div>
                                                <div className="btn_play_voice_icon w-embed"><svg width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="splide__slide button_ai_voice">
                                                <div className="audio_voice w-embed"><audio preload="none"
                                                        src="https://resource.heygencdn.com/homepage/EthanProfess_out.mp3"></audio>
                                                </div>
                                                <div className="btn_play_voice_icon w-embed"><svg width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="splide__slide button_ai_voice">
                                                <div className="audio_voice w-embed"><audio preload="none"
                                                        src="https://resource.heygencdn.com/homepage/Scarlettpro_out.mp3"></audio>
                                                </div>
                                                <div className="btn_play_voice_icon w-embed"><svg width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="splide__slide button_ai_voice">
                                                <div className="audio_voice w-embed"><audio preload="none"
                                                        src="https://resource.heygencdn.com/homepage/BelleNatur_out.mp3"></audio>
                                                </div>
                                                <div className="btn_play_voice_icon w-embed"><svg width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="splide__slide button_ai_voice">
                                                <div className="audio_voice w-embed"><audio preload="none"
                                                        src="https://resource.heygencdn.com/homepage/Alisoncheerful_out.mp3"></audio>
                                                </div>
                                                <div className="btn_play_voice_icon w-embed"><svg width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="voices_slider shadows_2 voice-fixed2">
                                <div className="voice_slider_heading_div">
                                    <h3 className="voices_slider_heading"><span className="purple-span">40+</span> languages
                                    </h3>
                                    <div className="slider_control_wrap">
                                        <div id="languages_prev_btn" className="btn_slide_left_icon w-embed"><svg width="20"
                                        ...
                                        <div id="languages_next_btn" className="btn_slide_right_icon is-active w-embed"><svg
                                                width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fillRule="evenodd" clip-rule="evenodd"
                                                    d="M16.5833 10C16.5833 10.4142 16.2475 10.75 15.8333 10.75L4.16658 10.75C3.75237 10.75 3.41658 10.4142 3.41658 10C3.41658 9.58579 3.75237 9.25 4.16658 9.25L15.8333 9.25C16.2475 9.25 16.5833 9.58579 16.5833 10Z"
                                    ...
                                    <div className="splide__track">
                                        <div className="splide__list voices_slider_content">
                                            <div className="splide__slide button_ai_voice_language">
                                                <div className="audio_voice w-embed"><audio preload="none"
                                                        src="https://resource.heygencdn.com/homepage/Japanese_out.mp3"></audio>
                                                </div>
                                                <div className="btn_play_voice_icon w-embed"><svg width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="splide__slide button_ai_voice_language">
                                                <div className="audio_voice w-embed"><audio preload="none"
                                                        src="https://resource.heygencdn.com/homepage/Spanish_out.mp3"></audio>
                                                </div>
                                                <div className="btn_play_voice_icon w-embed"><svg width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="splide__slide button_ai_voice_language">
                                                <div className="audio_voice w-embed"><audio preload="none"
                                                        src="https://resource.heygencdn.com/homepage/Germany_out.mp3"></audio>
                                                </div>
                                                <div className="btn_play_voice_icon w-embed"><svg width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="splide__slide button_ai_voice_language">
                                                <div className="audio_voice w-embed"><audio preload="none"
                                                        src="https://resource.heygencdn.com/homepage/French_out.mp3"></audio>
                                                </div>
                                                <div className="btn_play_voice_icon w-embed"><svg width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="splide__slide button_ai_voice_language">
                                                <div className="audio_voice w-embed"><audio preload="none"
                                                        src="https://resource.heygencdn.com/homepage/Korean_out.mp3"></audio>
                                                </div>
                                                <div className="btn_play_voice_icon w-embed"><svg width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="splide__slide button_ai_voice_language">
                                                <div className="audio_voice w-embed"><audio preload="none"
                                                        src="https://resource.heygencdn.com/homepage/Italian_out.mp3"></audio>
                                                </div>
                                                <div className="btn_play_voice_icon w-embed"><svg width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div data-w-id="caf9285d-5c9b-7374-d024-82fe7a9e7cf8" className="ai_voice_script">
                        <div className="ai_voice_script_grid">
                            <div className="ai_voice_script_script">
                                <div>
                                    <div className="text-block-90">Script</div>
                                    <div id="ai_voices_script" className="ai_voices_script"></div>
                                </div><a href="/" className="button-10 w-button">Generate voice</a>
                                <div className="html-embed-14 w-embed"><svg viewBox="0 0 488 302" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1.5 158.5L174.5 119" stroke="white" stroke-width="4"
                                            stroke-dasharray="1 2" />
                                        <path d="M1.5 158.5L309.5 300" stroke="white" stroke-width="4"
                                            stroke-dasharray="1 2" />
                                        <path d="M1.5 158.5L371.5 2.5" stroke="white" stroke-width="4"
                                            stroke-dasharray="1 2" />
                                        <path d="M1.5 158.5H488" stroke="white" stroke-width="4"
                                            stroke-dasharray="1 2" />
                                    </svg></div>
                            </div>
                            <div className="voices_videos_wrapper" style={{width:'100%'}}>
                                <div className="voice_script_card _4">
                                    ...
                                    <div className="ai_voice_video_wrap w-embed">
                                        ...
                                        <video className="ai_voice_video"
                                        ...
                                        loading="lazy" alt="" className="video-preview" />
                                </div>
                                <div className="voice_script_card _1">
                                    ...
                                    <div className="ai_voice_video_wrap w-embed"><video className="ai_voice_video"
