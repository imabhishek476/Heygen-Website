                    ...
                    <div className="avatars_head">
                        <div className="section_head_padding_2">
                            <div className="section_head_padding">
                                ...
                                <p className="heygen_para is-light avatar">Choose your perfect avatar covering different
                                    ethnicities, ages, poses and clothes.</p>
                            </div>
                            <div className="_2_btns_or_wrap"><a href="/" target="_blank"
                                ...
                                <div>or</div><a href="/" className="button_secondary w-inline-block">
                                    <div className="btn_video_icon w-embed"><svg width="17" height="16" viewBox="0 0 17 16"
                    ...
                    <div className="avatar_video_list">
                        <div className="avatar_video_item">
                            ...
                            <div className="avatar_video">
                                <div className="avatar_video_wrap w-embed"><video className="muted-video"
                                    ...
                                    loading="lazy" sizes="(max-width: 479px) 93vw, 100vw"
                            ...
                            <div className="avatars_section_item_line w-embed"><svg width="626" height="4"
                                    viewBox="0 0 626 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <line x1="1.74846e-07" y1="2" x2="626" y2="2.00005"
                                        stroke="url(#paint0_linear_1726_5082)" stroke-width="4"
                                        stroke-dasharray="1 2" />
                                    <defs>
                                        <linearGradient id="paint0_linear_1726_5082" x1="587.059" y1="5.00434"
                                            x2="-2.16798e-07" y2="5.00421" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#7559FF" />
                                            <stop offset="1" stop-color="#7559FF" stop-opacity="0" />
                                        </linearGradient>
                                    </defs>
                                </svg></div>
                        </div>
                        <div className="avatar_video_item">
                            <div className="avatar_video_heading_wrapper">
                                <div className="avatar_video_head">
                                    ...
                                    <p className="heygen_para is-light is-small">A professional-grade avatar for diverse
                                        application</p>
                                </div><a href="/" target="_blank"
                                    className="button_primary w-inline-block">
                                    <div>Get started for free</div>
                        ...
                        <div className="avatar_video_item">
                            <div className="avatar_video_heading_wrapper">
                                <div className="avatar_video_head">
                                    ...
                                    <p className="heygen_para is-light is-small">A dynamically animated photograph</p>
                                </div><a href="/" target="_blank"
                                    className="button_primary w-inline-block">
                                    <div>Get started for free</div>
                                    <div className="btn_right_arrow_icon w-embed"><svg viewBox="0 0 16 16" fill="none"
